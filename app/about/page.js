        ...
        <PageWrapper>
            <Container as="main">
                ...
                <Grid className='mt-40'>
                    <div className="col-span-12 768:col-span-4 1024:col-span-2">
                        <p className="copy-large">Fernanda Freitas</p>
                    </div>
                    <div className="col-span-12 768:col-span-8 1024:col-span-5 flex flex-col gap-y-20">
                    ...
                    <div className="col-span-12 768:col-span-auto">
