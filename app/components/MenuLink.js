    ...
    return (
         <Link 
            ...
            <div className="group-hover:h-full h-0 rotate-270 group-hover:rotate-0 transition-all duration-400 overflow-hidden flex bg-black rounded-full aspect-square">
                <svg className="m-auto size-10 scale-0 group-hover:scale-100 transition-all duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="white">
